...
<!-- GEMINI: Ask what the user needs for discovery work, then run the selected skill's logic inline. Do not run shell commands. -->
<!-- CODEX: Ask what the user needs from the discovery domain. Wait for reply before doing anything. -->

...
const FREE_SKILLS = [
  ...
  'pm-acceptance',
  'pm-estimation',
  // Framework skills — wired in v0.8.0
  'ansoff-matrix',
  'assumption-mapping',
...
`
  ...
  console.log(`  config.json, STATE.md, manifest.json, situation.md, goals.md (${allFiles.length} file(s) indexed)`)
